...
pub fn PSO(num_iteration: u32, n: u32, dim: u32, f:fn(u32, &Vec<f32>) -> Result<f32, benchmark_functions::FuncError>, x: (f32, f32), c: f32, w: f32, k: bool) -> Result<(Vec<f32>, Vec<f32>, Vec<Vec<f32>>), benchmark_functions::FuncError> {
        ...
        return Ok((S.get_best_solution(), res_func, S.get_Y()));
